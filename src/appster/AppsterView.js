...
export default class AppsterView {
    ...
    loadRoot(appData) {
        ...
        if (!appsterRootDiv) {
            ...
            let appsterEditTextInputModal = this.buildAppsterEditTextInputModal();
            ...
            appsterRootDiv.appendChild(appsterEditTextInputModal);
    ...
    buildAppsterEditTextInputModal() {
        let textModal = this.buildElement(  AppsterHTML.DIV, 
                                            AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL,
                                            [AppsterGUIClass.APPSTER_MODAL],
                                            [],
                                            null,
                                            AppsterGUIClass.MODAL_ANIMATION_LEFT);
        let textFrame = this.buildElement( AppsterHTML.DIV, 
                                            AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_FRAME,
                                            [AppsterGUIClass.APPSTER_MODAL_FRAME]);
        let header = this.buildElement( AppsterHTML.HEADER, 
                                        AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_HEADER,
                                        [AppsterGUIClass.APPSTER_MODAL_HEADER]);
        let section = this.buildElement(    AppsterHTML.SECTION, 
                                            AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_SECTION,
                                            [AppsterGUIClass.APPSTER_MODAL_SECTION]);
        let p = this.buildElement(AppsterHTML.P);
        let strong = this.buildElement(    AppsterHTML.STRONG, 
                                                "",
        ...
        textFieldAttributes[AppsterHTML.TYPE] = AppsterHTML.TEXT;
        let textField = this.buildElement(  AppsterHTML.INPUT,
                                            AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_TEXTFIELD,
                                            [AppsterGUIClass.APPSTER_MODAL_TEXTFIELD],
                                            textFieldAttributes);
        let enterButton = this.buildElement(   AppsterHTML.BUTTON, 
                                            AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_ENTER_BUTTON,
                                            [AppsterGUIClass.APPSTER_MODAL_BUTTON],
                                            [],
                                            AppsterText.APPSTER_TEXT_INPUT_MODAL_ENTER_BUTTON_TEXT);
        let cancelButton = this.buildElement(AppsterHTML.BUTTON, 
                                            AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_CANCEL_BUTTON,
                                            [AppsterGUIClass.APPSTER_MODAL_BUTTON],
                                            [],
                                            AppsterText.APPSTER_TEXT_INPUT_MODAL_CANCEL_BUTTON_TEXT);
        let footer = this.buildElement(     AppsterHTML.FOOTER, 
                                            "", 
                                            [AppsterGUIClass.APPSTER_EDIT_MODAL_FOOTER],
                                            [],
                                            AppsterText.APPSTER_TEXT_MODAL_FOOTER_TEXT);
...
//        this.controller.setupCallback(newA, AppsterHTML.ONCLICK, AppsterCallback.APPSTER_PROCESS_EDIT_WORK, callbackArguments);
    ...
    createScreen(){
        let textinput = document.getElementById(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL);
        textinput.classList.add(AppsterGUIClass.IS_VISIBLE);
    }

    createScreenClose(){
        let textinput = document.getElementById(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL);
        textinput.classList.remove(AppsterGUIClass.IS_VISIBLE);
    }

    createEditTextScreen(){
        let textinput = document.getElementById(AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL);
        textinput.classList.add(AppsterGUIClass.IS_VISIBLE);
    }

    createEditTextScreenClose(){
        let textinput = document.getElementById(AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL);
        textinput.classList.remove(AppsterGUIClass.IS_VISIBLE);
    }
   ...
   testinput(){
        let logoname = document.getElementById(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL_TEXTFIELD).value;
        return logoname;
    }

    getEditText(){
        let inputlogo = document.getElementById(AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_TEXTFIELD).value;
        return inputlogo;
    }

    editTextInput(textFill){
        
        let textinput = document.getElementById(AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL);
        document.getElementById(AppsterGUIId.APPSTER_EDIT_TEXT_INPUT_MODAL_TEXTFIELD).value = textFill;
        textinput.classList.add(AppsterGUIClass.IS_VISIBLE);
    }
