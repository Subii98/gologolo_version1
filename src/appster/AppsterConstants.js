...
export const AppsterCallback = {
    ...
    APPSTER_PROCESS_CANCEL_CREATE_WORK :"processCancelCreate",
    APPSTER_EDIT_TEXT : "editText",
    APPSTER_CANCEL_EDIT_TEXT : "cancelEditLogo",
    APPSTER_ENTER_EDIT_TEXT : "enterEditLogo",
    APPSTER_PROCESS_ENTER_CREATE_WORK : "confirmCreateYes",
    
    APPSTER_PROCESS_CONFIRM_OK : "confirmOkClose",

    APPSTER_CHANGE_COLOR : "changeTextColor",
    APPSTER_PROCESS_CAHNGE_FONT_SIZE : "changeFontSize",
    APPSTER_CHANGE_BACK_COLOR :"changeBackgroundColor",
    APPSTER_CHANGE_BORDER_COLOR : "changeBorderColor",
    APPSTER_CHANGE_BORDER_RADIOUS: "changeBorerRadius",
    APPSTER_CHANGE_BORDER_THICKNESS: "changeBorerThickness",
    APPSTER_CHANGE_PADDING:"changePadding",
    APPSTER_CHANGE_MARGIN: "changemargin"
};
...
export const AppsterGUIClass = {
    ...
    //classes for modal 2
    APPSTER_EDIT_MODAL: "appster_edit_modal",
    APPSTER_EDIT_MODAL_FRAME: "appster_edit_modal_frame",
    APPSTER_EDIT_MODAL_HEADER: "appster_edit_modal_header",
    APPSTER_EDIT_MODAL_SECTION: "appster_edit_modal_section",
    APPSTER_EDIT_MODAL_TEXTFIELD: "appster_edit_modal_textfield",
    APPSTER_EDIT_MODAL_BUTTON: "appster_edit_modal_button",
    APPSTER_EDIT_MODAL_FOOTER: "appster_edit_modal_footer",
};
...
export const AppsterGUIId = {
    ...
    //id for edit text modal
    APPSTER_EDIT_TEXT_INPUT_MODAL: 'appster_edit_text_input_modal',
    APPSTER_EDIT_TEXT_INPUT_MODAL_FRAME: 'appster_edit_text_input_modal_frame',
    APPSTER_EDIT_TEXT_INPUT_MODAL_HEADER: 'appster_edit_text_input_modal_header',
    APPSTER_EDIT_TEXT_INPUT_MODAL_SECTION: 'appster_edit_text_input_modal_section',
    APPSTER_EDIT_TEXT_INPUT_MODAL_TEXTFIELD: "appster_edit_text_input_modal_textfield",
    APPSTER_EDIT_TEXT_INPUT_MODAL_ENTER_BUTTON: 'appster_edit_text_input_modal_enter_button',
    APPSTER_EDIT_TEXT_INPUT_MODAL_CANCEL_BUTTON: 'appster_edit_text_input_modal_cancel_button',
};
...
export const AppsterText = {
    ...
    //APPSTER_INPUT_MODAL_PROMPT_TEXT : 
