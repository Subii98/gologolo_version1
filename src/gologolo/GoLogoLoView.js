...
export default class GoLogoLoView extends AppsterView {
    ...
    fillAppWorkspace(workspace) {
        ...
        editTextButton.innerHTML = this.appText[GoLogoLoText.GOLOGOLO_EDIT_TEXT_TEXT];
    ...
    loadWorkStyle(work) {
        ...
        textDiv.style.fontSize = (parseInt(work.getFontSize())) + "px";
        textDiv.style.color = work.getTextColor();
        textDiv.style.border = "10px solid #0000FF";
        ...
        textDiv.style.borderRadius = (parseInt(work.getBorderRadius())) + "px";
        //textDiv.style.borderThickness = work.getBorderThickness();
        textDiv.style.borderWidth = (parseInt(work.getBorderThickness())) + "px";
        //textDiv.style.padding = work.getPadding();
        textDiv.style.padding = (parseInt(work.getPadding())) + "px";
        //textDiv.style.margin = work.getMargin(); 
        textDiv.style.margin = (parseInt(work.getMargin())) + "px";      
    }
